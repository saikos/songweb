...
import com.song_list.entity.Movie;
 ...
 * @author saiko
 */
@WebServlet(name = "MovieListJPA", urlPatterns = {"/movies_jpa.html"})
public class MovieListJPA extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Movie> movies = manager.createNamedQuery("Movie.findAll", Movie.class).
                            getResultList();
